<?php
   ...
   function NextBarcodH($Code){
     ...
     $getLast = $db -> query("SELECT * FROM fdh where barcode LIKE '". $bcodestringformat ."' ORDER BY id DESC LIMIT 1");
    ...
    <br><br>
         ...
         <div class="card-body">
            ...
            <div class="row">
               <div class="col-lg-3">
                  ...
                  <input type="text" class="form-control" name="start_page" id="last_barcode" readonly value="<?php  echo UserAccount($Code)?>">
               </div>
               <div class="col-lg-3">
                  <label for="">Next Number to be generated</label>
                  <input type="number" class="form-control" name="start_page" id="next_barcode" value="<?php echo NextBarcodH($Code);?>">
               </div>
               <div class="col-lg-3">
                  <label for="">Add number to generate</label>
                  <input type="number" class="form-control" name="end_page" id="add_higher_num" value="<?php echo NextBarcodH($Code);?>">
               </div>
               <div class="col-lg-3">
                  <label for="">Choose Year</label>
                  <input type="number" class="form-control mb-3" name="yr_created" id="yr_created" value="<?php echo date("y")?>">
               </div>
            </div>
            ...
            <div class="card-footer text-muted">
               ...
               <a href="/v2" class="btn btn-outline-dark">RETURN HOME</a>
			    <a href="back.pdf" class="btn btn-outline-warning" target="_blank">PRINT BACK FORM</a>
            </div>
         </div>
      </div>
      ...
      <script>
         $('.prev').on('click', function(){
           ...
           var data = 'start_page='+next_barcode+'&end_page='+add_higher_num+'&yr_created='+yr_created+'&type=<?php echo $Code ;?>'
